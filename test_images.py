"""Test loop that will calculate image metrics and representative images for a few images in a "test_images" folder."""
...
tf.app.flags.DEFINE_float("l1", 0.001, "L1 regularizer for CS")
...
tf.app.flags.DEFINE_boolean("conjugate", "False", "Complex conjugate")
# Data dimensions
...
def main(_):
    ...
    with tf.Session(config=run_config) as sess:
        ...
        f = open(txt_path, "w")
        f.write(
            "parameters = " + str(total_parameters) + "\n"
            "output psnr = "
